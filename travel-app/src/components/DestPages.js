...
export default function DestPages(props) {
    return (
        <div>
            ...
            <img src={props.img} className="dest-page-img" alt={`${props.city} image`} />
            <p>
            ...
            <h4 className="dest-page-text">
                <span className="light-coral">About:<br /></span> {props.description}
            </h4>
            <h4 className="dest-page-text">
                <span className="light-coral">Sights:<br /></span>{props.popularSights}
            </h4>
        </div>
    );
}